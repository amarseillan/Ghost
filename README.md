# Clone from [Ghost](https://github.com/TryGhost/Ghost)
Implementing the user functionality explained in [this guide](http://labs.djenie.com/hacking-ghost-hunting-the-evil-spirit/) for personal use
